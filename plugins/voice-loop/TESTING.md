...
| | name | date | verdict |
|---|---|---|---|
| Tester | Claude (Opus 5) in WSL2 Ubuntu-24.04 / Windows 11 WSLg, plugin 0.8.0, server 0.5.0 | 2026-08-14 | 8.6 and 8.9 pass; 8.7 and 8.8 not reached |
| Waived items (with reason) | 8.7 (real microphone) and 8.8 (/voice-setup end to end) | 2026-08-14 | not waived — genuinely unmeasured; 8.7 was blocked by the rig having no capture device at all |
